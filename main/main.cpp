...
//         this->send_welcome(c);
// std::cout << "[" << getTime() << "] User \"" << c.nickname << "!~" << c.username << "@" << c.hostname << "\" registered (connection " << c.fd << ")" << std::endl;        c.regestred = true;
//         this->status = false;
//     }
// }%                                                                              ╭─ea
...
//         exit(1);
//     }
//     std::cout << "[" << getTime() << "] Server listening [::0]:" << _port << " (socket " << this->_fd_server << ")" << std::endl;
// }
...
//     ////////////////////////////////////////////////////////////////
//     std::cout << "[" << getTime() << "] Accepted Connection from: 127.0.0.1:" << _port << " (connection " << client_fd << ")" << std::endl;
//     ////////////////////////////////////////////////////////////////
...
//     std::cout << "[" << getTime() << "] Client disconnected (connection " << fd << ")" << std::endl;
// }
